...
export const CATEGORIES = [
  ...
  { name: 'Healing & Regeneration',    slug: 'healing',          color: '#EFF6FF', accentColor: '#1E40AF', icon: '💊', shopUrl: 'https://evolabsresearch.ca/healing-regeneration/' },
  ...
  { name: 'Reconstitution Supplies',   slug: 'supplies',         color: '#EFF6FF', accentColor: '#1E40AF', icon: '⚗️', shopUrl: 'https://evolabsresearch.ca/bac-water/' },
  { name: 'Research Kits - EVO Stacks',slug: 'kits',             color: '#EFF6FF', accentColor: '#1E40AF', icon: '📦', shopUrl: 'https://evolabsresearch.ca/evo-stacks/' },
];
